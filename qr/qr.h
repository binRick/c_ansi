...
module(qr) {
  ...
  module(qr_decode){
    ...
    module(qr_decode_path){
      ...
      bool          (*match)(const char *path, int match_index, unsigned char *data, size_t *len, size_t *capacity, int *bottom_left_x, int *top_left_x, int *top_right_x, int *bottom_right_x, int *bottom_left_y, int *top_left_y, int *to_right_y, int *bottom_right_y);
    } *path;
  } *decode;
};
